...
public class Parser {
    ...
    public static ArrayList<Model> parse() throws IOException, JSONException {
        ...
        for (int i = 0; i < root.length(); i++) {
            ...
            items.add(new Model(object.getJSONObject("_id").getString("$id"),
                    object.getString("creator"),
                    object.getJSONObject("date").getString("sec"),
                    object.getJSONObject("date").getString("usec"),
                    object.getString("title"),
                    object.getString("content"),
                    object.getString("blogID"),
                    object.getJSONArray("images").toString(),
